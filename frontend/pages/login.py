...
def show_login():
    st.set_page_config(layout="wide", page_title="Williams Sonoma | Login")
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* The actual content column — constrain width for form */
    [data-testid="stVerticalBlock"] {
        width: 100% !important;
    ...
    /* Remove any element spacing Streamlit inserts */
